...
_dataset_factory: dict[str, type] = {
    ...
    "cifar10_64": datasets.CIFAR10,
    "cifar100_64": datasets.CIFAR100,
    "super_cifar100": SuperCIFAR100,
    "super_cifar100_384": SuperCIFAR100,
    "super_cifar100_64": SuperCIFAR100,
...
def get_dataset(
    ...
    if name == "tiny-imagenet-200":
        ...
        pass_kwargs = {
            "root": root,
            "split": split,  # test set very small. Workaround
            "transform": transform,
            "target_transform": target_transform,
        }
